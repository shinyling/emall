package com.shiny.emall.common.utils;
 ...
 * @create 2018/9/5
 */
public class IdUtils implements Comparable<IdUtils>, java.io.Serializable {
    ...
    private static final Logger LOGGER = LogManager.getLogger("org.bson.ObjectId");
    ...
    @Override
    public int compareTo(IdUtils id) {
        if (id == null)
            return -1;
    ...
    public static void main(String[] args) {
        System.out.println(new IdUtils().toHexString());
        System.out.println(new IdUtils().toHexString());
        System.out.println(new IdUtils().toHexString());
    }
}
